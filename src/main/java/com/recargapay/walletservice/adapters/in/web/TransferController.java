...
public class TransferController {
    ...
    public TransferController(TransferFundsUseCase transferFundsUseCase, IdempotencyService idempotencyService) {
    ...
    public ResponseEntity<TransferResponse> transfer(
        ...
        return idempotencyService.executeIdempotent(idempotencyKey, httpRequest.getRequestURI(), TransferResponse.class, () -> {
