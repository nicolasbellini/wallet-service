...
public class WalletController {
    ...
    public ResponseEntity<DepositResponse> deposit(@PathVariable String walletId, @Valid @RequestBody DepositRequest request) {
    ...
    public ResponseEntity<WithdrawResponse> withdraw(@PathVariable String walletId, @Valid @RequestBody WithdrawRequest request) {
